...
function heartly_remove_demo_mode_link()
		...
		<div class="content">
			<div class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
				<div class="con">
					...
					<span><?php comment_date(get_option('date_format'), $comment); ?>
						<?php esc_html_e('at', 'heartly'); ?>
						<?php comment_time(get_option('time_format'), $comment); ?></span>
				</div>
			</div>
...
add_action('givewp_donation_form_enqueue_scripts', function () {
	wp_add_inline_style('givewp-donation-form-registrars', '
		...
		.givewp-donation-form>.givewp-layouts-header, .givewp-donation-form__steps-body {
			background: #FBF3E6 !important;
			
		}
		.givewp-fields-amount__currency-container, .givewp-fields-amount__currency-select {
